...
<xsl:output method="html" version="1.0" encoding="UTF-8" indent="yes"/>
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<h1><span class="company_name_title">Saigontimes Travel</span> Sitemap</h1>
					<p class="expl">
						Generated by 
						<a href="https://saigontimestravel.com/" target="_blank" rel="noopener"  class="company_name_subtitle">
							Saigontimes Travel
