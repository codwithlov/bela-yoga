...
const SearchSupport = (props: SearchSupportParams) => {
    ...
    //         return {
    //             key: index + 1,
    //             label: <div className='text-body-1 text-sgt-secondary-1'>{item.title}</div>,
    //             children: <div
    //                 className='max-sm:text-cap-1 text-body-2 text-sgt-secondary-1 ck-content'
    ...
    const SupportImageComponent = ({ className }: { className: string }) =>
        <div className={`${className}bg-sgt-secondary-1 bg-gradient-to-t from-sgt-primary-1 to-sgt-primary-2 aspect-square rounded-full`}>
        ...
        <section id='search_support' className='pb-16 mb-1 max-sm:pb-10 max-sm:px-4'>
            <div className='grid grid-cols-12 gap-y-10 md:gap-x-5'>
                <div className='col-span-12 md:col-span-3 mt-10 max-sm:mt-0'>
                    <div className='max-sm:hidden flex flex-row relative'>
                        <div className='w-1/2 flex flex-row relative'>
                            <div className='w-1/2 aspect-square rounded-full bg-sgt-neutral-7'></div>
                            <div className='w-1/2 aspect-square rounded-full bg-sgt-neutral-7 absolute right-0 bottom-0 -translate-y-1/4 -translate-x-1/4'></div>
                        </div>
                        <div className='w-1/2 flex flex-row relative'>
                            <div className='w-1/2 aspect-square rounded-full bg-sgt-neutral-7 absolute left-0 bottom-0 -translate-y-1/4 translate-x-1/4'></div>
                            <div className='w-1/2 aspect-square rounded-full bg-sgt-neutral-7 absolute right-0'></div>
                        </div>
                    </div>
                    <div className='bg-gradient-to-t from-sgt-primary-2 from-10% to-sgt-neutral-7 to-70% rounded-sgt-10 p-0.5 relative -top-10 max-sm:top-0'>
                        <div className='bg-sgt-neutral-7 rounded-sgt-10 relative'>
                            ...
                            <div className='pt-8 pb-4 px-5 max-sm:pt-4'>
                                <div className='flex flex-row justify-start gap-4'>
                                    ...
                                    <div className='flex-1 flex flex-col items-start md:items-center gap-2 md:gap-3.5 '>
                                        <h1 className='text-sub-1 text-sgt-secondary-1'>Bạn cần hỗ trợ ngay?</h1>
                                        <p className='text-cap-1 text-sgt-neutral-3 pb-2'>Với kinh nghiệm trong ngành du lịch chúng tôi tự tin có thể hỗ trợ bạn nhanh nhất</p>
                                    </div>
                                </div>
                                <a
                                    href={`tel:${PHONE.trim()}`}
                                    className='px-3 pt-4 rounded-md text-h4 text-sgt-secondary-1 flex flex-row justify-center items-center gap-2'>
                                    <div className='bg-sgt-third-2 h-8 w-8 rounded-full flex flex-row justify-center items-center'>
                                        <div className='bg-sgt-neutral-7'
                                            style={{
                                ...
                                <Divider className='!min-w-[80%] !w-4/5 !mx-auto !text-sgt-neutral-4 !text-cap-1 !my-3'>Hoặc</Divider>
                ...
                <div className='col-span-12 md:col-span-9'>
                    <div className='rounded-sgt-10 bg-sgt-neutral-7 h-auto overflow-hidden'>
                        <h3 className='text-h3 max-sm:text-lg text-sgt-secondary-1 pl-5 pt-6 pb-4'>Các câu hỏi thường gặp</h3>
                        <Collapse
                            ...
                            expandIcon={({ isActive }) =>
                                <div className='bg-sgt-neutral-3'
                                    style={{
