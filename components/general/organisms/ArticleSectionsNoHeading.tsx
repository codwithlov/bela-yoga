                    ...
                    {activeMenus.includes(index) ? (
                        <div className={contentClass}>
                            <div className='pt-3.5 pb-2 flex justify-between items-center cursor-pointer select-none' onClick={() => onClickTitle(index)}>
                                <span className='text-body-1 lg:text-sub-1 text-sgt-secondary-1 w-5/6'>{item.title}</span>
                                <div
                        ...
                        >
                            <span className='text-button lg:text-sub-1 text-sgt-neutral-3 mt-3.5 mb-3 w-5/6'>
                                {item.title}
                            </span>
                            <div
