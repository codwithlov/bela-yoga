...
const SearchBarHorizontal = async (props: SearchBarHorizontalParams) => {
    ...
    return (
        <section className='px-4 xl:px-0 bg-gradient-to-t from-sgt-primary-1 to-sgt-primary-2 h-20 flex justify-center items-center'>
                ...
                <div className='w-full grid grid-cols-12 gap-3'>
                    <div className='relative col-span-6 h-12  bg-white rounded-md  flex items-center'>
                        <SearchBarInputLocation
                            title={title}
                            inputClass='!font-medium !text-base !p-3 !pl-12 !text-sgt-neutral-4 placeholder:!text-sgt-neutral-4'
                            iconClass='bg-sgt-primary-1'
                    ...
                    <div className='relative col-span-4 h-12 bg-white rounded-md flex justify-center items-center'>
                        <SearchBarDate
                            inputClass='!font-medium !text-base !p-3 !pl-12 !text-sgt-neutral-4'
                            iconClass='bg-sgt-primary-1'
                        />
                    </div>
                    <div className='col-span-2'>
                        <SearchBarButton
                            btnClass='bg-white p-3 rounded-md text-button text-sgt-neutral-1 flex flex-row justify-center items-center cursor-pointer'
