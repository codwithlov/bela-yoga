    ...
    return (
        <>
            ...
            <a href={detailLink} className={`${props.className ? props.className : `col-span-4`} tour_item_vertical transition-all ease-linear duration-200 cursor-pointer`}>
                <div className='grid grid-cols-12 rounded-[0.625rem] shadow-bela-black-1 bg-white relative'>
                    ...
                    <div className='search_result_item_detail col-span-12 flex flex-col justify-between gap-5 pt-3 pb-4 px-2.5'>
                        <div className='search_result_item_detail flex flex-col gap-0.5'>
                            ...
                            <div className='search_result_item_detail_time flex flex-row justify-start items-center gap-1.5 pt-1'>
                                <div className='px-3 py-1.5 border border-bela-neutral-4 rounded-bela-10 text-cap-1 text-bela-neutral-3'>{item.day_number} Ngày {item.night_number} Đêm</div>
                                <div className='px-3 py-1.5 border border-bela-neutral-4 rounded-bela-10 text-cap-1 text-bela-neutral-3'>Vietjet Air</div>
                            </div>
                        </div>
                        <div className='flex flex-row justify-between items-end'>
                            <div className='flex flex-col justify-end items-start'>
                                {/* <div className='search_result_item_detail_price flex flex-row justify-start items-center gap-0.5 text-bela-neutral-4 text-sm font-normal'>
                                <div className='line-through'>{formatPrice((tourPrice ?? 0).toString())}đ</div>
                            </div> */}
                                <div className='search_result_item_detail_price flex flex-row justify-start items-center gap-0.5 text-xl font-bold text-bela-third-2'>
                            ...
                            </div>
                            {
                                ishowBtn ?
                                    <div className='pb-2 pr-0.5'>
                                        <a href={detailLink} className='px-5 py-1.5 rounded-lg bg-bela-primary-default text-bela-secondary-default font-bold hover:bg-bela-secondary-dark hover:text-white hover:transition-all'>
                                            Chọn
                                        </a>
                                    </div>
                                    : null
                    ...
                    <div className='flex flex-row justify-between items-center text-bela-neutral-7 bg-bela-third-2 rounded-md px-1 gap-0.5 shadow-bela-black-3'>
